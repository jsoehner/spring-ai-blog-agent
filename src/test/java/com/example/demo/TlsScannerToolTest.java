...
import com.example.demo.infrastructure.TlsScannerTool;
...
class TlsScannerToolTest {
    ...
    void testRunTlsScanWithInvalidDomain() {
        List<String> targets = List.of("https://invalid.localdomain");
        ...
        if (result.contains("Scan Results:")) {
            assertTrue(result.contains("https://invalid.localdomain"));
