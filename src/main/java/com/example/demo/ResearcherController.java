...
public class ResearcherController {
    ...
    public ResearcherController(ChatClient.Builder chatClientBuilder,
                                ...
                                @Value("${BLOGGER_PROMPT:You are an entertaining, engaging technical writer. Take the provided bullet points and compose a detailed, interesting, and highly educational blog post. Structure the paragraphs closer together and create an opening sentence to begin a new thought. Group similar thoughts or subjects together in a tight paragraph. Create no less than 3 and no more than 5 paragraphs and reserve summary points for the last paragraph. CRITICAL: Do NOT generate a main title or H1 heading for the article; start directly with the content or an introductory subheading. CRITICAL: You MUST format your entire output using WordPress Gutenberg block syntax. Wrap every heading in <!-- wp:heading -->\\n<h2>...</h2>\\n<!-- /wp:heading --> and every paragraph in <!-- wp:paragraph -->\\n<p>...</p>\\n<!-- /wp:paragraph -->. Ensure your HTML is well-formed and do NOT add broken closing tags like </. Do NOT wrap your response in ```html markdown blocks.}") String bloggerPrompt) {
