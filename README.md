...
- **[ADR-0012: Gutenberg Tag Healer Integration for Valid WordPress HTML Structure](file:///Users/jsoehner/spring-ai-blog-agent/docs/architecture/decisions/0012-gutenberg-tag-healer-integration.md)** — Documents the addition of `GutenbergTagHealer` to automatically wrap blocks in `<p>` and `<h2>` HTML tags when missing.
