...
- **[ADR-0005: Fixing CI/CD Test Failures and Semgrep Warning](file:///Users/jsoehner/spring-ai-blog-agent/docs/architecture/decisions/0005-fixing-ci-cd-test-failures.md)** — Outlines the resolutions for build context issues, Semgrep false positive command injection alert, and test assertions in `TlsScannerToolTest.java` that blocked nightly dependency update pipelines.
